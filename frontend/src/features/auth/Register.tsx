...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validar correo UNAL
    if (!authService.validateUNALEmail(email)) {
      setEmailError("Debes usar un correo institucional @unal.edu.co");
      return;
    }
    ...
    try {
      ...
      dispatch(registerFailure(error.response?.data?.message || "Error al registrarse"));
    }
  };
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Mapa UNAL - Registro</p>
